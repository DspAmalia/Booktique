...
namespace Booktique.Migrations
{
    ...
    [Migration("20260708160729_int_approved_book_mig")]
    partial class int_approved_book_mig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booktique.Models.MainModels.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Booktique.Models.MainModels.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Booktique.Models.MainModels.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("Booktique.Models.MainModels.ChatMessage", b =>
                {
                    b.HasOne("Booktique.Models.MainModels.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("Booktique.Models.MainModels.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Booktique.Models.MainModels.OrderItem", b =>
                {
                    ...
                    b.HasOne("Booktique.Models.MainModels.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
